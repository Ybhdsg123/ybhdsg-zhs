...
<div class="moment" style="padding: 15px; background: #fff; border-bottom: 1px solid #f0f0f0;">
  ...
  <br>
</section>`;B(r),b("代码已复制到剪贴板！")}function m(){document.querySelector(".code-output").select()}return(r,e)=>(M(),k("div",q,[e[18]||(e[18]=t("h1",{class:"title"},"公众号模版-朋友圈格式生成器",-1)),t("div",E,[t("div",H,[e[8]||(e[8]=t("label",null,"头像预览:",-1)),t("img",{src:s.value.avatar,alt:"头像预览",class:"preview-img"},null,8,I),e[9]||(e[9]=t("label",null,"头像链接:",-1)),d(t("input",{"onUpdate:modelValue":e[0]||(e[0]=a=>s.value.avatar=a),placeholder:"输入头像链接（如：https://example.com/avatar.jpg）"},null,512),[[p,s.value.avatar]])]),t("div",L,[e[10]||(e[10]=t("label",null,"昵称:",-1)),d(t("input",{"onUpdate:modelValue":e[1]||(e[1]=a=>s.value.nickname=a),placeholder:"输入昵称"},null,512),[[p,s.value.nickname]])]),t("div",P,[e[11]||(e[11]=t("label",null,"发布时间（如：刚刚，10分钟前）:",-1)),d(t("input",{"onUpdate:modelValue":e[2]||(e[2]=a=>s.value.time=a),placeholder:"输入时间（如：10分钟前）"},null,512),[[p,s.value.time]])]),t("div",S,[e[12]||(e[12]=t("label",null,"动态内容:",-1)),d(t("textarea",{"onUpdate:modelValue":e[3]||(e[3]=a=>s.value.content=a),placeholder:"输入动态内容，支持换行"},null,512),[[p,s.value.content]])]),t("div",D,[e[13]||(e[13]=t("label",null,"图片链接（多张用逗号分隔）:",-1)),d(t("input",{"onUpdate:modelValue":e[4]||(e[4]=a=>s.value.images=a),placeholder:"输入图片链接，多个用逗号分隔"},null,512),[[p,s.value.images]])]),t("div",F,[e[14]||(e[14]=t("label",null,"点赞人（用逗号分隔）:",-1)),d(t("input",{"onUpdate:modelValue":e[5]||(e[5]=a=>s.value.likes=a),placeholder:"输入点赞人，多个用逗号分隔"},null,512),[[p,s.value.likes]])]),t("div",O,[e[15]||(e[15]=t("label",null,"评论（格式：昵称:内容，多个用分号分隔）:",-1)),d(t("textarea",{"onUpdate:modelValue":e[6]||(e[6]=a=>s.value.comments=a),placeholder:"输入评论，格式：张三:好棒;李四:不错"},null,512),[[p,s.value.comments]])]),t("button",{onClick:o,class:"add-btn"},"添加动态")]),t("div",A,[e[16]||(e[16]=t("h2",{class:"section-title"},"预览效果",-1)),t("div",G,[t("div",{class:"wechat-moments",innerHTML:n.value},null,8,J)])]),t("div",R,[e[17]||(e[17]=t("h2",{class:"section-title"},"生成的HTML代码",-1)),d(t("textarea",{"onUpdate:modelValue":e[7]||(e[7]=a=>n.value=a),readonly:"",class:"code-output",onClick:m},null,512),[[p,n.value]]),t("button",{onClick:c,class:"copy-btn"},"复制代码")])]))}},Q=V(K,[["__scopeId","data-v-78dc87ad"]]),Y=JSON.parse('{"title":"公众号模版：模版1 - 朋友圈","description":"","frontmatter":{},"headers":[],"relativePath":"pages/gzh/template_pyq/index.md","filePath":"pages/gzh/template_pyq/index.md"}'),W={name:"pages/gzh/template_pyq/index.md"},Z=Object.assign(W,{setup(l){return(i,s)=>(M(),k("div",null,[s[0]||(s[0]=t("h1",{id:"公众号模版-模版1-朋友圈",tabindex:"-1"},[N("公众号模版：模版1 - 朋友圈 "),t("a",{class:"header-anchor",href:"#公众号模版-模版1-朋友圈","aria-label":'Permalink to "公众号模版：模版1 - 朋友圈"'},"​")],-1)),t("div",null,[U(Q)])]))}});export{Y as __pageData,Z as default};
