(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.NoviceGuide = factory());
	...
	var HighlightElement = (function () {
	    ...
	    HighlightElement.prototype.createEl = function () {
	        ...
	        this.el.className = "".concat(prefix, "highlight-el");
	...
	var infoElement = (function () {
	    function infoElement(app) {
	        this.app = app;
	        this.app = app;
	        this.el = null;
	        this.app.on('after-step-change', this.onStepChange.bind(this));
	    }
	    infoElement.prototype.show = function (step) {
	    ...
	    infoElement.prototype.showInnerInfo = function (step) {
	        return __awaiter$1(this, void 0, void 0, function () {
	            var error_1, res;
	            return __generator$1(this, function (_a) {
	                switch (_a.label) {
	    ...
	    infoElement.prototype.createHTML = function (step) {
	        var _this = this;
	    ...
	    infoElement.prototype.createEl = function () {
	    ...
	    infoElement.prototype.removeEl = function () {
	        if (this.el) {
	            document.body.removeChild(this.el);
	            this.el = null;
	        }
	    };
	    infoElement.prototype.onStepChange = function (stepIndex) {
	        var _a = this.app.options, nextText = _a.nextText, prevText = _a.prevText, completeText = _a.completeText, useCustomInfo = _a.useCustomInfo;
	        if (useCustomInfo)
	            return;
	    ...
	    infoElement.prototype.onClick = function (e) {
	    ...
	    infoElement.prototype.getInfoRect = function (step, el) {
	        if (step.element) {
	    ...
	    infoElement.prototype.computeInfoPosition = function (step, el) {
